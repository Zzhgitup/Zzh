...
export default MyTheme({
  ...
  repo: "https://github.com/Zzhgitup",
  ...
  blog: {
    medias: {
      ...
      Email: "zzhcodespace@gmail.com",
      // Evernote: "https://example.com",
      // Facebook: "https://example.com",
      // Flipboard: "https://example.com",
      // Gitee: "https://example.com",
      GitHub: "https://github.com/Zzhgitup",
      // Gitlab: "https://example.com",
      Gmail: "zzhcodespace@gmail.com",
  ...
  plugins: {
    ...
    comment: {
      provider: "Waline",
      serverURL: "https://walinetalk-1090649095-qqcom.vercel.app/", // your server url
      reaction: true,
      requiredMeta: ["nick"],
      wordLimit: 300,
      emoji: [
